...
contract HelperConfig is Script {
    ...
    function getAnvilConfig() public returns (NetworkConfig memory) {
        // if we dont assign an address to these variables, it will be address(0) (0x0000000000000000000000000000000000000000)
        // hence, we check it
        ...
        return (
            NetworkConfig({
                ...
                wethUsdPriceFeedAddress: address(wethUsdPriceFeed),
